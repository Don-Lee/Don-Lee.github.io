...
![](https://github.com/Don-Lee/Notes/blob/master/Images/Gitalk1.png)

点击创建

获取 `Client ID` 和 `Client Secret`，后面我们会用到这2个参数。

![](https://github.com/Don-Lee/Notes/blob/master/Images/Gitalk2.png)
...
![](https://github.com/Don-Lee/Notes/blob/master/Images/Gitalk3.png)
